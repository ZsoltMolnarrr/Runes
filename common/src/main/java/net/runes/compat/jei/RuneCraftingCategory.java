...
public class RuneCraftingCategory extends AbstractRecipeCategory<RecipeHolder<RuneCraftingRecipe>> {
    /**
    ...
    public RuneCraftingCategory(IGuiHelper guiHelper) {
        ...
        super(TYPE,
                Component.translatable("gui.runes.rune_crafting"),
                guiHelper.createDrawableItemLike(RuneCraftingBlock.ITEM),
                124, 18);
    }

    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, RecipeHolder<RuneCraftingRecipe> entry, IFocusGroup focuses) {
        ...
        builder.addOutputSlot(103, 1).setOutputSlotBackground().add(recipe.result().create());
    }

    @Override
    public void createRecipeExtras(IRecipeExtrasBuilder builder, RecipeHolder<RuneCraftingRecipe> entry, IFocusGroup focuses) {
